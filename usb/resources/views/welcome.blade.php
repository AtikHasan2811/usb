            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">Tel/Fax</label>
                            <div class="col-sm-10">
                                <input type="tex" class="form-control" id="inputPassword" placeholder="Tel/Fax">
                            </div>
                        </div>


                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">e-mail/web</label>
                            <div class="col-sm-10">
                                <input type="tex" class="form-control" id="inputPassword" placeholder="e-mail/web">
                            </div>
                        </div>
...
{{--                        </div>--}}
                        ...
                        <div class="card-header mt-5 " style="height: 50px;">
                            <div>
                                <div class="float-left">PROCESSING UNITE</div>
                                <div class="float-right" id="hide_div">
                                    <a type="button" class="delete-row btn btn-outline-danger" style=" margin-top: -5px; margin-left: 10px;">Delete Row</a>
                                </div>
                                <div class="float-right"> <a id="addunit" class="btn btn-outline-danger add-row" style=" margin-top: -5px;">Add Unit</a></div>
